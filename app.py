...
<head>
    ...
    <style>
        ...
        .btn-save { width: 100%; padding: 12px; background: #4285f4; color: white; border: none; border-radius: 6px; font-size: 16px; font-weight: bold; cursor: pointer; transition: 0.2s; }
...
<body>
    ...
    <script>
        ...
        document.getElementById('configForm').addEventListener('submit', async (e) => {
            ...
            if(res.ok) {
                statusMsg.textContent = "✅ تم حفظ الإعدادات بنجاح!";
...
# ===================================================================
#  Unified Routes (Fixes 405 Method Not Allowed)
# ===================================================================
...
if __name__ == '__main__':
    app.run(host='0.0.0.0', port=PORT)        .status { margin-top: 20px; text-align: center; padding: 10px; border-radius: 6px; display: none; }
        .success { background: #1e8e3e; color: white; }
        .error { background: #d93025; color: white; }
        .info-box { background: #2d2d2d; padding: 15px; border-radius: 6px; margin-top: 20px; font-size: 13px; color: #9aa0a6; line-height: 1.6; }
        .warning-box { background: #3b2f1e; border: 1px solid #ff9800; padding: 15px; border-radius: 6px; margin-top: 20px; font-size: 13px; color: #ffcc80; line-height: 1.6; }
